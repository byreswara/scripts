locals {
  ...
  default_agent_pool_profile = [local.default_agent_profile]
  ...
  private_dns_zone              = var.private_dns_zone_type == "Custom" ? var.aks_private_dns_zone_id : var.private_dns_zone_type 
