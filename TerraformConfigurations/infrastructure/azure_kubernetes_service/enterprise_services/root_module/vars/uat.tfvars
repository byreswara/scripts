...
aks_subnet_name          = "snet-uat-k8cni-01"
vnet_name                = "vnet-uat-central-01"
vnet_resource_group_name = "rg-uat-core-01"

# keyvault data source variables:
key_vault_name                = "keyvault-uat-cus-es-01"
key_vault_resource_group_name = "rg-keyvault-uat"

# acr data source variables:
acr_name                = "mercalisuat"
acr_resource_group_name = "rg-acr-uat"

# aks name variables:
aks_name            = "aks-uat-cus-es-01"
resource_group_name = "rg-aks-uat-cus-es-01"
ssh_key_name        = "ssh-aks-uat-cus-es-01"
