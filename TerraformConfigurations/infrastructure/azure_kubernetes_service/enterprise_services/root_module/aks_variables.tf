...
variable "Identity_subscription_name" {
  description = "Name of the Identity subscription"
  type        = string
}
variable "aks_name" {
...
# Currently not used in main.tf - commented incase we need it later
# variable "aks_subnet_name" {
#   description = "Name of the subnet used for AKS"
#   type        = string
# }
